...
- 🏫 **School** — École Supérieure en Informatique, Sidi Bel Abbès
- 📚 **Major** — Artificial Intelligence & Data Science *(AISD)*
- 🤖 **Passion** — Everything AI: ML, Deep Learning, LLMs, you name it
- ☕ **Fuel** — Coffee + curiosity + late-night coding sessions
- 🎯 **Goal** — Make machines smarter (and occasionally break them trying)
